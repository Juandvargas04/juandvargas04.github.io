...
<a class="navbar-brand" href="index.html">Arquitectura VB</a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   <li class="nav-item nav-item-hover"><a class="nav-link" href="index.html">Inicio</a></li>
   ...
   <li class="nav-item nav-item-hover"><a class="nav-link" href="research.html">Sobre mi</a></li>
   <li class="nav-item nav-item-hover"><a class="nav-link" href="https://arquitecturavb.blogspot.com/" target="_blank">Blog</a></li>
   <li class="nav-item">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 justify-content-center">
          <table>
            <tr>
              <th><button id="lnch1" type="button"><a class="nav-link" href="experience.html">Experiencia</a></th>
            </tr>
            <tr>
              <th><button id="lnch1" type="button"><a class="nav-link" href="projects.html">Proyectos</a></th>
            </tr>
            <tr>
              <th><button id="lnch1" type="button"><a class="nav-link" href="education.html">Educación</a></th>
            </tr>
            <tr>
              <th><button id="lnch1" type="button"><a class="nav-link" href="research.html">Sobre mi</a></th>
            </tr>
            <tr>
              <th><button id="lnch1" type="button"><a class="nav-link" href="https://arquitecturavb.blogspot.com/" target="_blank">Blog</a></th>
            </tr>
            <tr>
              <th><button id="lnch1" type="button"><a class="nav-link" href="index.html">Inicio</a></th>
            </tr>
          </table>
        </div>
        ...
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 form-container">
          <div class="form-style-6">
            ...
            <form name="form1" action="https://formcarry.com/s/MODbsq9_YR-" method="POST" accept-charset="UTF-8" >
              <input id="name" type="text" name="name" placeholder="Tu nombre" required/>
              <input id="email" type="email" name="email" placeholder="Tu correo electrónico" required/>                  
              <textarea id="textArea" name="message" placeholder="Tu mensaje" required></textarea>
